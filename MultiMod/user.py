...
class User:
	def __init__(user_info, parent_sub, username, date_created, analysis_time, total_comment_karma, total_post_karma, total_karma, comment_karma_counter, post_karma_counter, pos_comment_counter, neg_comment_counter, pos_post_counter, neg_post_counter, pos_QC_counter, neg_QC_counter):
		...
		for sub in parent_sub.all_subs:
			user_info.net_QC_counter[sub] = pos_QC_counter[sub] - neg_QC_counter[sub]
			net_QC_str += (sub + ' ' + str(net_QC_counter[sub]) + ' ')
		...
		user_info.info_dict = {
			...
			'comment_karma' : comment_karma_counter
			'post_karma' : post_karma_counter
			'total_comment_karma' : total_comment_karma
			'total_post_karma' = total_post_karma
			'total_karma' : total_karma
			'pos_comment' : pos_comment_counter
			'neg_comment' : neg_comment_counter
			'pos_post' : pos_post_counter
			'neg_post' : neg_post_counter
			'pos_QC' : pos_QC_counter
			'neg_QC' : neg_QC_counter
			'net_QC' : net_QC_counter
